...
class SizeBasedComparatorTest {
    ...
    public void CheckChildrenOfRootDirectoryInOrder() {
        ...
        LinkedList<FSElement> actual = root.getChildren(new SizeBasedComparator());
    ...
    public void CheckChildrenOfHomeDirectoryInOrder() {
        ...
        LinkedList<FSElement> actual = home.getChildren(new SizeBasedComparator());
        assertArrayEquals(expected,actual.toArray());
    }
    ...
    public void CheckSubDirectoryOfRootDirectoryInOrder() {
        ...
        LinkedList<Directory> actual = root.getSubDirectories(new SizeBasedComparator());
        assertArrayEquals(expected,actual.toArray());
    }
    ...
    public void CheckChildrenOfPicturesDirectoryInOrder() {
        File[] expected = {b,a};
        LinkedList<File> actual = pictures.getFiles(new SizeBasedComparator());
        assertArrayEquals(expected,actual.toArray());
    }
